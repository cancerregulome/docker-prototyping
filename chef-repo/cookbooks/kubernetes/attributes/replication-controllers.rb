# Replication controller attributes
# Zookeeper rc attributes
default["kubernetes"]["replication_controllers"]["zookeeper"]["v1beta3"]["definition"] = "/etc/kubernetes/replication_controllers/zookeeper-controller.json"
