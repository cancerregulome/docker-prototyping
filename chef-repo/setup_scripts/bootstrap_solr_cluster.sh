...
cp $chef_repo/cookbooks/solrcloud/files/default/dockerfiles/zookeeper/config/zoo.cfg.template $chef_repo/cookbooks/solrcloud/files/default/dockerfiles/zookeeper/config/zoo.cfg
